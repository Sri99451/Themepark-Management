...
if (strlen($_SESSION['tpmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $ftp=$_POST['ftprice'];
       ...
       $query=mysqli_query($con, "update tblprice set MaleTIcket= '$mtp',FemaleTIcket= '$ftp',KidsTicket= '$ktp' where id='1' ");
    if ($query) {
...
<html>
<head>
<title>Theme Park Management System || Update Pricing</title>
