...
<html>
<head>
<title>Theme Park Management System || Manage Pass</title>
...
<div id="wrapper">
  ...
  <span style="float:left" ><i class="fa fa-print fa-2x" aria-hidden="true" OnClick="CallPrint(this.value)" style="cursor:pointer" title="Print the Report"></i></span> 
  	<h3 align="center">#<?php echo $_GET['tikcetno'];?> Details</h3>
...
$ret=mysqli_query($con,"select *from  tblentrytickets where id='$ticketid'");
